        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <p class="text-center">
                    ...
                    <a href="Controlador/vaciarcarrito.php" class="btn btn-danger btn-block"><i class="fa fa-trash"></i>   Vaciar carrito</a>
                </p>
            </div>
        </div>
    </div>
...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs"><!-- Menu computadoras y tablets -->
            <div class="col-xs-4">
                  ...
                  <a href="index.php"><figure class="logo-navbar"></figure></a>
                <a href="index.php"><p class="text-navbar tittles-pages-logo">Dolce Crepe</p></a>
            ...
            <div class="col-xs-8">
                <div class="contenedor-tabla pull-right">
                    <div class="contenedor-tr">
                        ...
                        <a href="product.php" class="table-cell-td">Tienda</a>
                        <a href="acerca.php" class="table-cell-td" >Acerca de</a>
                        <?php
                            if(!$_SESSION['nombreAdmin']==""){
                                ...
                                echo '
                                    ...
                                    <a href="#" class="table-cell-td" data-toggle="modal" class="social-icon all-elements-tooltip"  data-placement="bottom" title="Whatsapp" class="btn btn-primary" data-toggle="modal" data-target=".hola2">
                                        &nbsp;'.$_SESSION['nombreUser'].'
                                    </a>
                                 ';
                            }else{
  ...
  <!-- Modal Micuenta -->
    <div class="modal fade hola2" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabes">
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="margin-right:15px;">&times;</button>
            <h4 class="modal-title text-center text-primary" id="myModalLabel">Mi Cuenta</h4>
          </div>


         <h4 data-dismiss="modal"><a href="#" class="table-cell-td " data-toggle="modal" data-target=".modal-logout" style="color:black;"><i class="glyphicon glyphicon-log-out" ></i>&nbsp;Cerrar Sesion</a></h4>
         <h4> <a href="cuenta.php" class="table-cell-td " style="color:black;"><i class="glyphicon glyphicon-user"></i>&nbsp;Mis Datos</a></h4>
    ...
    <div class="modal fade modal-login" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
            ...
            <form action="Controlador/login.php" method="post" role="form" style="margin: 20px;" class="FormCatElec" data-form="login">
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Dolce Crepe</h3>
    ...
    <div class="modal fade modal-carrito" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="padding: 20px;">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <p class="text-center">El producto se agrego al carrito</p>
    ...
    <div class="modal fade modal-logout" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="padding: 20px;">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <p class="text-center">
                <a href="Controlador/logout.php" class="btn btn-primary btn-sm">Cerrar la sesion</a>
                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Cancelar</button>
            </p>
          </div>
      </div>
