                ...
                <div class="col-xs-12">
                    ...
                    <div id="myTabContent" class="tab-content">
                      <div role="tabpanel" class="tab-pane fade" id="all-product" aria-labelledby="all-product-tab">
                        ...
                        <div class="row">
                        <?php
                            $consulta=  ejecutarSQL::consultar("select * from producto where CodigoProd > 0");
                      ...
                      <?php
                        ...
                        while($categ=mysql_fetch_array($consultar_categorias)){
                            echo '<div role="tabpanel" class="tab-pane fade active in" id="'.$categ['CodigoCat'].'" aria-labelledby="'.$categ['CodigoCat'].'-tab"><br>';
                                $consultar_productos= ejecutarSQL::consultar("select * from producto where CodigoCat='".$categ['CodigoCat']."' and CodigoProd > 0");
                                             ...
                                             <div class="thumbnail">
                                               ...
                                               <div class="caption">
                                                 ...
                                                 <p class="text-center">
                                                     ...
                                                     <button value="'.$prod['CodigoProd'].'" class="btn btn-success btn-sm botonCarrito"><i class="fa fa-shopping-cart"></i>&nbsp; Agregar</button>
                                                 </p>
