...
<body id="container-page-registration">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 text-center" id="actua">
                    <h1 class="white-color">Registro de usuarios </h1>
                   <br><br><br><br><br><br><br><br><br><br><br>
                    <p><i class="fa fa-users fa-5x white-color"></i></p>
                    <p class="lead white-color">
                        Al registrarse recibira notificaciones de nuestros productos y ofertas mas recientes en nuestra tienda.
                    </p>
                ...
                <div class="col-xs-12 col-sm-6" id="actua">
                   <br><br>
                    <div id="container-form">
                       ...
                       <br><br>
                       <form class="form-horizontal FormCatElec" action="Controlador/regclien.php" role="form" method="post" data-form="save" id="pot" name="pot">
                           <div class="form-group">


                              <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-credit-card"></i></div>
                                <input class="form-control all-elements-tooltip" type="hidden" placeholder="Ingrese su número de NIT" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="ID de Usuario" maxlength="30" id="clien_nit" >
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su número de NIT" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="ID de Usuario" maxlength="30" id="clien_nit2" disabled>
                              </div>
    ...
    $(document).ready(function(){
      var numram=Math.floor((Math.random() * 2000) + 1000);
  document.pot.clien_nit.value=numram
  document.pot.clien_nit2.value=numram
    })
    </script>
